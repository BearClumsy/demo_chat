output "alb_dns_name" {
  description = "Public DNS name of the ALB. Point the production hostname at this."
...
output "container_env" {
  description = <<-EOT
    ...
    up with modules/server/src/main/resources/application-prod.properties. Secret keys
