...
- Use `var` to declare a local variable without writing its type explicitly when the type is already
  obvious from the right-hand side, instead of writing the type name twice.
